...
public class Course {
    ...
    private boolean validateDate(String begin, String end) {
        ...
        if ((Integer.parseInt(b[0]) < Integer.parseInt(e[0]))
                || (Integer.parseInt(b[0]) <= Integer.parseInt(e[0]) && Integer.parseInt(b[1]) < Integer.parseInt(e[1]))
                || (Integer.parseInt(b[0]) <= Integer.parseInt(e[0]) && Integer.parseInt(b[1]) <= Integer.parseInt(e[1]) && Integer.parseInt(b[2]) < Integer.parseInt(e[2]))) {
            return true;
        }
        return false;
    }
